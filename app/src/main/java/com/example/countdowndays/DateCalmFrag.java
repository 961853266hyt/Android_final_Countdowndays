 ...
 */
public class DateCalmFrag extends androidx.fragment.app.Fragment implements View.OnClickListener {
    private Button from_date,to_date,add_sub_date;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        add_sub_date = (Button)view.findViewById(R.id.add_sub_date);
